"""
Django settings for ethi_back project.
...
STORAGES = {
     "default": {
        ...
        "OPTIONS": {
            "location": BASE_DIR / "media",  # or wherever your media files are
        },
    },
    # ...
    "staticfiles": {
...
WSGI_APPLICATION = 'ethi_back.wsgi.application'
...
BASE_URL = os.getenv("REACT_BASE_URL","http://localhost:5173")
CORS_ALLOW_HEADERS = [
    'authorization',
    'content-type',
]
